      ...
      <div className={`cand-page${fadingOut ? ' fading-out' : ''}`}>
        ...
        <nav className="cand-nav">
          <div className="cand-nav-left">
            <Image src="/gctu-crest.png" alt="GCTU" width={36} height={36} className="cand-nav-crest" />
        ...
        <div className="cand-modal">
          ...
          {candidate && (
            <>
              ...
              <button className="cand-modal-dl-btn">
                <Download size={14} className="verify-icon-inline" /> Download Full Manifesto (PDF)
              </button>
            </>
          )}
        </div>
